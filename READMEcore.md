...
Mock-Up
The following video  https://bootcampspot.instructure.com/courses/4010/assignments/59476?module_item_id=1040609 shows an example of the application being used from the command line:
...
+-------------------------+-----------+--+-----------------------+
| id INT (key-role)| id INT           | id INT                   |
| name VARCHAR(30) | title VARCHAR(30)| first_name VARCHAR(30)   |
|                  | salary DECIMAL   | last_name VARCHAR(30)    |
| | department_id INT (key-department)| role_id INT (key to role)|
| |                                   | manager_id INT           |
